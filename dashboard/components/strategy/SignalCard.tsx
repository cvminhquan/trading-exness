  ...
  <Card>
    ...
    <CardContent className="space-y-5">
      <div>
        ...
        <p className="mt-1 text-sm leading-relaxed text-slate-200">{signal.summary}</p>
      </div>
      ...
      <dl className="grid grid-cols-2 gap-3 sm:grid-cols-5">
        {[
          ...
          <div key={String(label)} className="rounded-lg border border-slate-800 bg-slate-950/50 p-3">
            <dt className="text-xs uppercase tracking-wide text-slate-500">{label}</dt>
            <dd className="mt-1 tabular-nums text-sm font-medium text-slate-100">
