"""Simple file + memory cache for ExternalMarketContext."""
...
class ExternalContextCache:
    ...
    def _path(self, symbol: str) -> Path:
        return self._root / f"{symbol.upper()}_external_context_cache.json"
    ...
    def get(
        ...
        *,
        ...
        """Return (payload, age_seconds, expires_at_iso) or (None, None, None)."""
    ...
    def put(
        ...
        *,
        ...
        with self._lock:
            ...
            hist = self._root / f"{symbol.upper()}_external_context_history.jsonl"
                    ...
                    json.dumps(
                        {
                            ...
                            "external_bias": payload.get("external_bias"),
